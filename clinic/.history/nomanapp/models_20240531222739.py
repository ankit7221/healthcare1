...
class Product(models.Model):
    name = models.CharField(max_length=100)
    stripe_product_id = models.CharField(max_length=100,default='your_default_value_here')
...
class Price(models.Model):
    ...
    stripe_price_id = models.CharField(max_length=100,default='your_default_value_here')
