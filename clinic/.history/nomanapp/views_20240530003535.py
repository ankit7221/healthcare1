...
def make_appointment(request):
    ...
    if request.user.is_authenticated:
        # If user is authenticated, proceed with the appointment form
        return render(request, 'appointment_form.html', {'form': form})
    else:
        # If user is not authenticated, provide login and signup options
        login_form = LoginForm()  # Create a login form
        signup_form = UserCreationForm()  # Create a signup form
